...
있으며 (DOI:
[10.17605/OSF.IO/RCT9Y](https://doi.org/10.17605/OSF.IO/RCT9Y)), 관리형
...
[`download_data()`](https://taehyun-lim.github.io/krpoltext/reference/download_data.md)는
...
데이터는 `tools::R_user_dir("krpoltext", "cache")`에 압축 RDS 형태로
캐시되며, SHA-256 체크섬으로 검증됩니다. 이후 로딩은 대체로 약 2초
내외로 끝납니다.
...
학술 작업에서 데이터를 사용할 경우, 먼저 Data Descriptor 논문을 인용해
주세요.
...
- **데이터**: [CC BY-NC-ND
  4.0](https://taehyun-lim.github.io/krpoltext/LICENSE-DATA.md) — 자세한
  조건은 [OSF 프로젝트](https://osf.io/rct9y/)와 [Data
  Descriptor](https://doi.org/10.1038/s41597-025-05220-4)를 참고하세요.
