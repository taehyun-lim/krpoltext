...
default; the examples below make that explicit. The public
`campaign_booklet` artifact is documented in enriched form and includes linked
NEC fields such as `huboid`, `sg_id`, `sg_typecode`, and `link_status`.
